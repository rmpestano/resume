...
* Create and maintain in house JavaEE 6+ based solutions for speed up internal development
...
Languages and Specifications:: Java SE, *Java EE* (JSF, BV, JPA, EJB, CDI, JAX-RS, Servlet, JSP), J2EE, JavaScript, XML, JSON, CSS/Less/Sass, AsciiDoc, Swagger
...
** Presented http://rmpestano.github.io/talks/slides/javaee-pipeline/[JavaEE Pipeline as code with Docker, Jenkins and Sonar]
