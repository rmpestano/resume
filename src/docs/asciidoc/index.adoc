...
Languages and Specifications:: Java SE, *Java EE* (JSF, BV, JPA, EJB, CDI, Servlet, JSP), J2EE, JavaScript, XML, JSON, CSS, AsciiDoc, Swagger
...
* {link-adminfaces}[AdminFaces^]: JSF Template and Primefaces theme based on Bootstrap and AdminLTE
* {link-rsjug-site}[RSJug^]: Jekyll based site for our local Jug
