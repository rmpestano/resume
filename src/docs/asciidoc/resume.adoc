...
Rafael attends and speaks at {link-resume}/#conferences-presentations[conferences] on *Java EE*, like The Developers Conference and also give talks at {link-rsjug}[local Jug]. +
...
I frequently write blog posts at http://rpestano.wordpress.com/[rpestano.workdpress, role="external", window="_blank"].
...
* Sport : Football (soccer) and muscle training in academy
* TV Shows
